...
import com.att.gfp.ciena.cienaPD.CienaExtendedLifeCycle;
 ...
 * 
 */
public final class CienaUnreachableTrap extends ProblemDefault implements
		ProblemInterface {
	private static Logger log = LoggerFactory.getLogger(CienaUnreachableTrap.class);
