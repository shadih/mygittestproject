...
//
public final class OAM_Suppression extends ProblemDefault implements ProblemInterface 
{

	private Logger log = LoggerFactory.getLogger(OAM_Suppression.class);
	public OAM_Suppression() {
		super();
	...
	public boolean isMatchingTriggerAlarmCriteria(Alarm a) throws Exception {
		...
		if (!alarm.isSuppressed())
		{
			...
			String watchdogDesc = "OAM watch dog.";
...
", alarm be_time_stamp = " + alarm.getCustomFieldValue("be_time_stamp"));
	...
	public void whatToDoWhenSubAlarmIsAttachedToGroup(Alarm a, Group group) throws Exception {
		...
		{
			log.info("alarm = " + trigger.getIdentifier() + " is suppressed due to existence of 50002/100/11 or 50002/100/9.");
