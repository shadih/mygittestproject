...
//
public final class A_Z_OAM_Suppression extends ProblemDefault implements ProblemInterface 
{

	private Logger log = LoggerFactory.getLogger(A_Z_OAM_Suppression.class);
	public A_Z_OAM_Suppression() {
		super();
	...
	public boolean isMatchingTriggerAlarmCriteria(Alarm a) throws Exception {
		...
		if ("CIENA NTE".equals(alarm.getDeviceType()))
		{
			...
			String watchdogDesc = "A_Z_OAM watch dog.";
...
", alarm be_time_stamp = " + alarm.getCustomFieldValue("be_time_stamp"));
	...
	public void whatToDoWhenSubAlarmIsAttachedToGroup(Alarm a, Group group) throws Exception {
		...
		{
    			log.info("Suppressed Ciena OAM alarm(A-Z): " + trigger.getIdentifier() + " due to A_Z correlation.");
