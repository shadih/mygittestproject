...
public final class Ciena_OAM_FRU_Suppression extends JuniperSyslog_ProblemDefault implements ProblemInterface {

	private Logger log = LoggerFactory.getLogger(Ciena_OAM_FRU_Suppression.class);
	public Ciena_OAM_FRU_Suppression() {
		super();

	}
	// Item 7 under Ciena OAM of Ciena Req from Gayathri
	@Override
...
"CIENA EMUX".equals(alarm.getDeviceType())) && "JUNIPER MX SERIES".equals(alarm.getRemoteDeviceType()))
		{
