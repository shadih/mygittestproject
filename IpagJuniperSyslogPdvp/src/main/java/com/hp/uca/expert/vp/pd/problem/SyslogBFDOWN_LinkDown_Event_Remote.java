 ...
 * 
 */
public final class SyslogBFDOWN_LinkDown_Event_Remote extends JuniperSyslog_BFDOWN_Default implements
		ProblemInterface {

	private Logger log = LoggerFactory
			.getLogger(SyslogBFDOWN_LinkDown_Event_Remote.class);

	public SyslogBFDOWN_LinkDown_Event_Remote() {
		super();		
		setLog(LoggerFactory.getLogger(SyslogBFDOWN_LinkDown_Event_Remote.class));
	}
