...
public class preprocessClearAlarmTest extends AbstractJunitIntegrationTest {

	private static Logger log = LoggerFactory.getLogger(preprocessClearAlarmTest.class);
	private static final String SCENARIO_BEAN_NAME = "ipagPreprocess.preprocess";
	
	private static final String IPAG_CLEARALARMTEST_ALARM = "src/test/resources//com/att/gfp/data/ipagPreprocess/preprocess/clearAlarmTestAlarm.xml";
	private static final String IPAG_CLEARALARMTESTDUP_ALARM = "src/test/resources//com/att/gfp/data/ipagPreprocess/preprocess/clearAlarmTestDuplicateAlarm.xml";
	...
	public void setUp() throws Exception {
		log.info(Constants.TEST_START.val() + preprocessClearAlarmTest.class.getName());
	...
	public void tearDown() throws Exception {
		log.info(Constants.TEST_END.val() + preprocessClearAlarmTest.class.getName()
				+ Constants.GROUP_ALT1_SEPARATOR.val());
	}

	// Way to run tests via ANT Junit
	public static junit.framework.Test suite() {
		return new JUnit4TestAdapter(preprocessClearAlarmTest.class);
	}
...
//		getProducer().sendAlarms(IPAG_DEVSEVSUPPRESS_ALARM);
//		
//		Thread.sleep(5*SECOND);
		...
		getProducer().sendAlarms(IPAG_CLEARALARMTESTDUP_ALARM);
