 ...
 *  
 */
public class AdtLportNonPppLinkLcpCorrelator extends AdtTrapsCorrProblemDefault {

	private Logger log = LoggerFactory
	.getLogger(AdtLportNonPppLinkLcpCorrelator.class);  
	public AdtLportNonPppLinkLcpCorrelator() {
		super();
	} 
	@Override
